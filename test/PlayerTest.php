...
{
  public function test_player_construct()
  {
    $player = new Player(2);
  ...
  public function test_set_random_pivot_point() 
  {
    $player = new Player(2);
  ...
  public function test_set_pivot_point_index() 
  {
    $player = new Player(2);
  ...
  public function test_update_proposed_coordinate_index() 
  {
    $player = new Player(4);
  ...
  public function test_update_proposed_coordinate() 
  {
    $player = new Player(4);
